#!/usr/bin/env python3
"""Register extracted infrared/visible frames with the RIFT2 rotation repository."""
...
RIFT2_SRC = REPO_ROOT / "RIFT2-multimodal-matching-rotation-python"
if str(RIFT2_SRC) not in sys.path:
    sys.path.insert(0, str(RIFT2_SRC))

from src.RIFT2 import RIFT2  # noqa: E402


DEFAULT_INPUT_ROOT = Path("data/video_data_20260521/frames")
DEFAULT_OUTPUT_ROOT = Path("data/video_data_20260521/rift2_registration")
TARGET_SIZE = (640, 512)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Register infrared and visible extracted frames with RIFT2."
    )
    parser.add_argument(
        "--input-root",
        type=Path,
